...
try {
  foreach ($relative in @('infra/main', 'infra/stages/10-workloads', 'infra/stages/40-optional-advanced', 'infra/stages/41-sentinel-content', 'infra/stages/70-observability-agent', 'infra/modules/lab-console-platform', 'infra/modules/lab-console-job')) {
